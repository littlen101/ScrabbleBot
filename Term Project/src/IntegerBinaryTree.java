...
public class IntegerBinaryTree<V>  extends BinaryTree<Integer, V> {
	/**
	...
	public IntegerBinaryTree<V> join (IntegerBinaryTree<V> rightChild) {
		V buff = null;
		Node<Integer,V> newRoot = new Node<>(((int) root.key + (int) rightChild.root.key), buff);
		newRoot.setLeft(root);
		newRoot.setRight(rightChild.root);
		return (new IntegerBinaryTree<V>(newRoot));
	}
